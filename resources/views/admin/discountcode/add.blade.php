                ...
                <div class="col-md-6">
                    <form action="{{ route('admin.discountcode.store')}}" method="Post">
                        ...
                        <div class="form-group">
                            <label>Code</label>
                            <input name="code" class="form-control" placeholder="Nhập code">
                        </div>
                        <div class="form-group">
                            <label>Price</label>
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" name="start_time" class="form-control" placeholder="Nhập giá">
                        </div>
                        <div class="form-group">
                            <label>End time</label>
                            <input type="date" name="end_time" class="form-control" placeholder="Nhập giá">
                        </div>
                        <div class="form-group">
                            <label>Product</label>
